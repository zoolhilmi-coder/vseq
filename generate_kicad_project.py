...
def create_kicad_project():
  ...
  "project": {
    ...
    sexp.append('        (polyline (polyline (point 0 -1.27) (point 0 1.27)) (stroke (width 0.254)))')
    sexp.append('        (polyline (polyline (point 0 -1.27) (point -0.635 -1.524)) (stroke (width 0.254)))')
    sexp.append('        (polyline (polyline (point 0 1.27) (point 0.635 1.524)) (stroke (width 0.254)))')
    sexp.append('        (polyline (polyline (point -1.27 1.27) (point 1.27 0) (point -1.27 -1.27) (point -1.27 1.27)) (stroke (width 0.254)) (fill (type outline)))')
    sexp.append('      )')
    ...
    sexp.append('        (polyline (polyline (point -5.08 5.08) (point -5.08 -5.08) (point 5.08 0) (point -5.08 5.08)) (stroke (width 0.254)) (fill (type outline)))')
    sexp.append('      )')
    ...
    sexp.append('        (polyline (polyline (point 0 0) (point 0 -1.27)) (stroke (width 0.152)))')
    sexp.append('        (polyline (polyline (point -2.54 -1.27) (point 2.54 -1.27)) (stroke (width 0.152)))')
    sexp.append('        (polyline (polyline (point -1.27 -2.54) (point 1.27 -2.54)) (stroke (width 0.152)))')
    sexp.append('        (polyline (polyline (point -0.635 -3.81) (point 0.635 -3.81)) (stroke (width 0.152)))')
    sexp.append('      )')
    ...
    sexp.append('        (polyline (polyline (point 0 0) (point 0 1.27)) (stroke (width 0.152)))')
    sexp.append('        (polyline (polyline (point 0 1.27) (point -0.635 0.635) (point 0 1.27) (point 0.635 0.635)) (stroke (width 0.152)))')
    sexp.append('      )')
